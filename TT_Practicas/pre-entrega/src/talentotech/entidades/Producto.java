...
public class Producto {
    ...
    public void setNombre(String nuevoNombre){
        if (Objects.isNull(nuevoNombre) || nuevoNombre.length() == 0) return;
        this.nombre = nuevoNombre;
    }

    public void setPrecio(double nuevoPrecio){
        if (nuevoPrecio <= 0d) return;
        this.precio = nuevoPrecio;
    }

    public void setDescripcion(String nuevaDescripcion){
        if (Objects.isNull(nuevaDescripcion) || nuevaDescripcion.length() == 0) return;
    ...
    public boolean equals(Object obj){
        if (Objects.isNull(this) || obj.getClass() == this.getClass()) return false;
